...
jQuery.fn.quickpaginate = function( settings ) {
	...
	var setNav = function()
	{
		...
		var pagerNav = $('<p align="center"><a class="'+settings.prev+'" href="#"><i class="fa fa-arrow-circle-left"></i> </a><a class="'+settings.next+'" href="#"> <i class="fa fa-arrow-circle-right"></i></a></p>');
